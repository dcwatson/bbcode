...
class ParserTests (unittest.TestCase):
    ...
    TESTS = (
        ...
        ('[url]http://foo.com/s.php?some--data[/url]', '<a rel="nofollow" href="http://foo.com/s.php?some--data">http://foo.com/s.php?some--data</a>'),
        ('[url=apple.com]link[/url]', '<a rel="nofollow" href="http://apple.com">link</a>'),
        ('www.apple.com blah foo.com/bar', '<a rel="nofollow" href="http://www.apple.com">www.apple.com</a> blah <a rel="nofollow" href="http://foo.com/bar">foo.com/bar</a>'),
        ('[color=red]hey now [url=apple.com]link[/url][/color]', '<span style="color:red;">hey now <a rel="nofollow" href="http://apple.com">link</a></span>'),
        ...
        ('[url="<script>alert(1);</script>"]xss[/url]', '<a rel="nofollow" href="&lt;script&gt;alert(1);&lt;/script&gt;">xss</a>'),
        ...
        ('http://www.google.com"onmousemove="alert(\'XSS\');"', '<a rel="nofollow" href="http://www.google.com%22onmousemove=%22alert(\'XSS\')">http://www.google.com"onmousemove="alert(\'XSS\')</a>;&quot;'),
        ...
        ('http://github.com/ http://example.org http://github.com/dcwatson/', '<a rel="nofollow" href="http://github.com/">http://github.com/</a> <a rel="nofollow" href="http://example.org">http://example.org</a> <a rel="nofollow" href="http://github.com/dcwatson/">http://github.com/dcwatson/</a>'),
